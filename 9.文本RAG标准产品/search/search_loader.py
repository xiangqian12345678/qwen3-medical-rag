...
class SearchConfigLoader:
    ...
    def __init__(self, config_path: str = None):
        ...
        if config_path is None:
            ...
            self.config_path = config_dir / "search_config.yaml"
        else:
        ...
        self._dict = raw
        self.search_agent_config = SearchAgentConfig(**raw.get("agent", {}))
    ...
    @property
    def search_agent(self) -> SearchAgentConfig:
        """获取搜索Agent配置"""
        return self.search_agent_config
