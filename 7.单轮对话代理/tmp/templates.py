...
def get_prompt_template(template_name: str) -> Union[Dict[str, str], str]:
    ...
    获取提示模板
    示例1: 找到了对应的模板
        get_prompt_template("dialogue_rag")
        返回: {"system": "...", "user": "..."}  # dialogue_rag 的模板

    示例2: 没找到，返回默认值 basic_rag
        get_prompt_template("unknown_template")
        返回: {"system": "...", "user": "..."}  # basic_rag 的模板（作为默认值）
    """
